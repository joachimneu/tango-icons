...
tangoicontheme_source_folder = os.path.join(source_folder, "tango-icon-theme")
svg_source_folders = [ os.path.join(tangoicontheme_source_folder, "scalable") ]
    ...
    for folder in svg_source_folders:
        for container in os.listdir(folder):
            ...
            for filename in os.listdir(src_folder):
                ...
                names.add(container + '_' + filename[:-4])
                tar = f"{os.path.join(pdf_temp_folder, container + '_' + filename[:-4])}.pdf"
